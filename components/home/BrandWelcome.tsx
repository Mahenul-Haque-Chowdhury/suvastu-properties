...
export default function BrandWelcome() {
  return (
    <section className="relative overflow-hidden border-b border-brand-pearl bg-white px-6 py-16 md:px-12 md:py-20">
      ...
      <div className="relative mx-auto grid max-w-[1500px] items-stretch gap-6 lg:grid-cols-[minmax(520px,0.95fr)_minmax(0,1.45fr)] lg:gap-10">
        <div className="relative flex min-h-[220px] items-center overflow-hidden rounded-[26px] border border-brand-pearl/90 bg-[linear-gradient(180deg,var(--color-brand-white)_0%,var(--color-brand-pearl)_100%)] px-6 py-8 text-brand-black shadow-[0_18px_55px_rgba(27,33,39,0.08)] md:px-12 md:py-10 lg:min-h-[280px] lg:rounded-[44px] lg:px-14">
          ...
          <div className="relative max-w-[420px] pt-2">
            ...
            <div className="text-[38px] font-semibold leading-[0.94] tracking-[-0.055em] text-brand-black sm:text-[44px] md:text-[60px] lg:text-[72px]">
        ...
        <div className="relative overflow-hidden rounded-[26px] bg-brand-black px-6 py-8 text-brand-pearl shadow-[0_30px_90px_rgba(27,33,39,0.16)] md:px-12 md:py-10 lg:rounded-[44px] lg:px-14">
          ...
          <div className="relative max-w-4xl">
            <h2 className="max-w-3xl text-[28px] font-semibold leading-[1.04] tracking-[-0.04em] text-brand-white sm:text-[32px] md:text-[44px] lg:text-[52px]">
