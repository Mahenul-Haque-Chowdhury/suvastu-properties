...
export default function CTA() {
  ...
  return (
    <section ref={containerRef} className="py-32 md:py-48 relative overflow-hidden border-b border-brand-pearl">
      <div 
        ref={bgRef} 
      ...
      <div className="max-w-6xl mx-auto px-6 text-center flex flex-col items-center relative z-10" ref={textContainerRef}>
        ...
        <h2 className="mb-8 text-[44px] font-semibold leading-[0.95] tracking-[-0.045em] text-brand-black md:text-[82px]">
          Ready to elevate <br /> your everyday?
        </h2>
        
        <p className="mb-14 max-w-2xl text-[15px] leading-8 text-brand-charcoal md:text-base">
        ...
        <div className="grid w-full grid-cols-1 gap-6 text-left md:grid-cols-2">
          <Link
            ...
            className="group relative overflow-hidden rounded-[28px] border border-brand-pearl bg-white px-8 py-8 shadow-[0_16px_40px_rgba(27,33,39,0.08)] transition-transform duration-300 hover:-translate-y-1"
          >
            ...
            <div className="relative">
              ...
              <h3 className="mb-4 text-[30px] font-semibold leading-[1] tracking-[-0.04em] text-brand-black md:text-[36px]">
          ...
          <Link
            ...
            className="group relative overflow-hidden rounded-[28px] border border-brand-charcoal/20 bg-brand-black px-8 py-8 text-brand-pearl shadow-[0_22px_50px_rgba(27,33,39,0.16)] transition-transform duration-300 hover:-translate-y-1"
          >
            ...
            <div className="relative">
              ...
              <h3 className="mb-4 text-[30px] font-semibold leading-[1] tracking-[-0.04em] text-brand-white md:text-[36px]">
